...
class MaliyetHesaplama1Screen extends StatefulWidget {
  const MaliyetHesaplama1Screen({Key? key}) : super(key: key);

  @override
  _MaliyetHesaplama1ScreenState createState() =>
      _MaliyetHesaplama1ScreenState();
}

class _MaliyetHesaplama1ScreenState extends State<MaliyetHesaplama1Screen> {
  ...
  AppBar appBar(BuildContext context) {
    return AppBar(
      ...
      actions: [
        IconButton(
          onPressed: () {
            Navigator.pushReplacementNamed(context, "/maliyetHesaplama");
          },
  ...
  AlertDialog changeInformation(int i) {
    return AlertDialog(
      actions: [changeInformationDone(i)],
      scrollable: true,
